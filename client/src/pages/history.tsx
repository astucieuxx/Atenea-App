  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative py-12 lg:py-16 border-b border-border/50">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center space-y-4">
            <h1 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-foreground animate-fade-up" style={{ animationDelay: '0.1s' }}>
              Mis Casos
            </h1>
            <p className="text-lg text-muted-foreground font-body max-w-2xl mx-auto animate-fade-up" style={{ animationDelay: '0.2s' }}>
          ...
          {cases.length === 0 ? (
            <Card className="border-border shadow-lg animate-fade-up" style={{ animationDelay: '0.4s' }}>
              <CardContent className="py-16 text-center">
                ...
                <p className="text-sm text-muted-foreground max-w-sm mx-auto mb-8 font-body">
