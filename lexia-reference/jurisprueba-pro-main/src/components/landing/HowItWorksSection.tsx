      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 lg:mb-20">
          ...
          <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-6">
            Cómo <span className="text-gradient-silver">Funciona</span>
          </h2>
          ...
          {steps.map((step, index) => (
            <div key={step.title} className="relative text-center">
              ...
              <div className="relative inline-block mb-8">
                ...
                <span className="absolute -top-3 -right-3 w-8 h-8 rounded-full bg-gradient-silver text-navy-dark font-bold text-sm flex items-center justify-center shadow-silver">
                  {step.step}
                </span>
              </div>
