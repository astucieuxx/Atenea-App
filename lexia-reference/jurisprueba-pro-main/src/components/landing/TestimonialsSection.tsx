...
const testimonials = [
  {
    ...
    content: "LexIA ha revolucionado la forma en que hacemos investigación. Lo que antes tomaba horas, ahora lo resuelvo en minutos. Imprescindible para cualquier despacho serio.",
    rating: 5
  },
  {
  ...
  },
  {
    ...
    content: "Implementamos LexIA en todo nuestro equipo legal. La productividad aumentó significativamente y la calidad de nuestros argumentos mejoró notablemente.",
    rating: 5
  }
];
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 lg:mb-20">
          ...
          <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-6">
            Lo que Dicen
            <span className="text-gradient-silver"> Nuestros Usuarios</span>
          </h2>
          <p className="text-lg text-muted-foreground font-body">
            Miles de profesionales del derecho confían en LexIA cada día.
          </p>
        </div>
